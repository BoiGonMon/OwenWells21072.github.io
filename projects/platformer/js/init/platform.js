(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(500, 575, 0.5, 1);
        platform.create(200, 500, 0.5, 1);
        platform.create(500, 425, 0.5, 1);
        platform.create(200, 350, 0.5, 1);
        platform.create(500, 275, 0.5, 1);
        platform.create(200, 200, 0.5, 1);
        platform.create(500, 125, 0.5, 1);
